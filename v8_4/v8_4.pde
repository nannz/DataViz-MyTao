...
void drawCircle(int y, int m, float p,int l) {// int c, float p) {    y = year ; m = month
  circleX = (2*section*(y-1)+sectionMonth*(2*m-1))/2;
  //circleX = random(section*(y-1)+sectionMonth*(m-1), section*(y-1)+sectionMonth*m);
